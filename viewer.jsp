    ...
    <div class="iphone horizontal">
    	...
    	<div class="display">
            <div class="screen">
            	<br/><br/><br/>	
				<div>
					<video id=home_video class="video-js vjs-default-skin" controls preload="auto" poster="http://video-js.zencoder.com/oceans-clip.jpg"  width="480" height="200" data-setup="{}">
	                    <source src="http://95.110.145.186:8080/30secs/oceans-clip.mp4" type="video/mp4" />
	                    <source src="http://95.110.145.186:8080/30secs/oceans-clip.webm" type='video/webm'/>
                	</video>
				</div>
				<br/>
